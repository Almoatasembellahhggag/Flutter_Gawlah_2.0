  ...
  Future addPost({@required List<String>survey}) async {
    ...
    if (!_editting) {
     ...
     await _firestoreService
        .addPosttt(User(survey: survey,id: currentUser.id,fullName: currentUser.fullName,userRole: currentUser.userRole,review: currentUser.review,email: currentUser.email));
    } else {
